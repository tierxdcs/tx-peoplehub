    ...
    steps: [
      {
        key: 'lead',
        label: 'Lead',
        detail: 'A new prospect enters the pipeline.',
        href: '/sales/leads',
      },
      { key: 'qualify', label: 'Qualify', detail: 'Assess fit and intent.' },
      {
        key: 'opportunity',
        label: 'Opportunity',
        detail: 'A qualified deal being worked.',
        href: '/sales/opportunities',
      },
      {
        key: 'assessment',
        label: 'Bid/No-Bid',
        detail: 'Sales Head approves whether to bid.',
        gate: true,
      },
      {
        key: 'bid',
        label: 'Bid',
        detail: 'Priced proposal prepared for the customer.',
        href: '/sales/bids',
      },
      {
        key: 'discount',
        label: 'Discount approval',
        detail: 'Required when the discount exceeds 10%.',
        gate: true,
      },
      {
        key: 'accepted',
        label: 'Customer accepts',
        detail: 'The customer agrees to the bid.',
      },
      {
        key: 'order',
        label: 'Order',
        detail: 'Bid converts to a confirmed order.',
        href: '/sales/orders',
      },
      {
        key: 'ocs',
        label: 'Confirmation Sheet',
        detail: 'Customer signs; Sales Head countersigns.',
        gate: true,
      },
      {
        key: 'released',
        label: 'Released to production',
        detail: 'Handed off to the production floor.',
      },
    ],
  },
  {
    ...
    steps: [
      {
        key: 'item',
        label: 'Item Master',
        detail: 'Items and technical data defined.',
        href: '/scm/items',
      },
      {
        key: 'draft',
        label: 'BOM drafted',
        detail: 'A multi-level bill of materials is built.',
        href: '/scm/bom',
      },
      {
        key: 'submitted',
        label: 'BOM submitted',
        detail: 'Sent for technical approval.',
      },
      {
        key: 'approved',
        label: 'R&D Head approves',
        detail: 'Only a designated R&D Head can approve.',
        gate: true,
      },
      {
        key: 'released',
        label: 'BOM released',
        detail: 'Locked and versioned.',
      },
      {
        key: 'available',
        label: 'Available for production',
        detail: 'Drives stock explosion and manufacturing.',
      },
    ],
  },
  {
    ...
    steps: [
      {
        key: 'need',
        label: 'Material need',
        detail: 'Identified from a kickoff shortfall or manually.',
      },
      {
        key: 'rfq',
        label: 'RFQ',
        detail: 'Floated to 3 or more suppliers/vendors.',
        href: '/scm/rfqs',
      },
      {
        key: 'quotes',
        label: 'Sealed quotes',
        detail: 'Quotes stay hidden until the RFQ closes.',
      },
      {
        key: 'compare',
        label: 'Comparison',
        detail: 'Quotes compared side by side.',
      },
      {
        key: 'award',
        label: 'Award',
        detail: 'Justification required if not the lowest.',
        gate: true,
      },
      {
        key: 'po',
        label: 'Purchase Order',
        detail: 'A DRAFT PO is pre-filled from the award.',
        href: '/stores/purchase-orders',
      },
      {
        key: 'received',
        label: 'Goods received',
        detail: 'A GRN records the incoming material.',
      },
    ],
  },
  {
    ...
    steps: [
      {
        key: 'po',
        label: 'PO issued',
        detail: 'A purchase order is placed on a supplier.',
      },
      {
        key: 'grn',
        label: 'GRN on receipt',
        detail: 'Goods recorded — no stock yet.',
        href: '/stores/grn',
      },
      {
        key: 'qc',
        label: 'QC inspection',
        detail: 'Incoming quality gate.',
        gate: true,
      },
      {
        key: 'stock',
        label: 'Stock / NCR',
        detail: 'Accepted qty enters stock; rejected raises an NCR.',
      },
      {
        key: 'indent',
        label: 'Material indent',
        detail: 'Production requests material.',
        href: '/stores/material-issue',
      },
      {
        key: 'issue',
        label: 'Material issued',
        detail: 'Reservation-aware issue from stores.',
      },
      {
        key: 'manufacture',
        label: 'Manufacturing',
        detail: 'The work order is built.',
      },
      {
        key: 'finalqc',
        label: 'Final QC',
        detail: 'Finished goods cleared before shipping.',
        gate: true,
      },
      {
        key: 'dispatch',
        label: 'Dispatch',
        detail: 'Delivery challan; stock leaves; draft invoice raised.',
    ...
    steps: [
      {
        key: 'incoming',
        label: 'Incoming QC',
        detail: 'Inspect material received on a GRN.',
        gate: true,
      ...
      },
      {
        key: 'ncr',
        label: 'Accept / reject',
        detail: 'Rejections raise an NCR for disposition.',
      },
      {
        key: 'inprocess',
        label: 'In-process checks',
        detail: 'Checks during manufacturing.',
      },
      {
        key: 'final',
        label: 'Final QC clearance',
        detail: 'Required before dispatch.',
        gate: true,
      },
    ],
  },
    ...
    steps: [
      {
        key: 'draft',
        label: 'Draft invoice',
        detail: 'Dispatch seeds a DRAFT sales invoice.',
        href: '/finance/ar/invoices',
      },
      {
        key: 'submit',
        label: 'Finance submits',
        detail: 'Finance reviews and submits it.',
      },
      {
        key: 'approve',
        label: 'Accounts Head approves',
        detail: 'The sole approver signs off.',
        gate: true,
      },
      {
        key: 'issued',
        label: 'Issued & posted',
        detail: 'Invoice issued and posted to the GL.',
      },
      {
        key: 'receipt',
        label: 'Customer receipt',
        detail: 'Payment recorded when it arrives.',
      },
      {
        key: 'allocated',
        label: 'Allocated',
        detail: 'Receipt applied against the invoice.',
      },
    ],
  },
  {
    ...
    steps: [
      {
        key: 'onboard',
        label: 'Onboarding',
        detail: 'Personnel record created.',
        href: '/hr/onboard',
      },
      {
        key: 'access',
        label: 'Access granted',
        detail: 'Role and login assigned.',
        gate: true,
      },
      {
        key: 'leave',
        label: 'Leave & attendance',
        detail: 'Day-to-day people operations.',
      },
      {
        key: 'payroll',
        label: 'Payroll',
        detail: 'Monthly salary processing.',
      },
    ],
  },
];
