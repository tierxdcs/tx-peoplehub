 ...
 * Captures the supplier master fields. "Registered/factory address" doubles as
 * the origin location for raw-material suppliers.
 */
    ...
    <Dialog open onOpenChange={(o) => !o && onClose()}>
      <DialogContent className="max-h-[90vh] max-w-2xl overflow-y-auto">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <Field label="Registered address / origin location" required htmlFor="s-reg" className="sm:col-span-2">
