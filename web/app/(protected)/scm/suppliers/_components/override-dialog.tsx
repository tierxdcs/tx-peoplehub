...
const CLASSIFICATION_OPTIONS: { value: SupplierClassification; label: string }[] = [
  { value: 'APPROVED_PREFERRED', label: 'Approved (Preferred Supplier)' },
...
export function OverrideDialog({
  ...
  async function submit() {
    ...
    setError(null);
    try {
      await overrideAuditClassification(supplierId, audit.id, {
        ...
        <div className="space-y-4">
          <div className="rounded-md bg-muted px-3 py-2 text-sm">
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              ...
              takes precedence and drives the supplier’s status.
            </p>
          </div>
          ...
          <Field label="Override classification" htmlFor="o-class">
            <Select
              ...
              onChange={(e) =>
                setClassification(e.target.value as SupplierClassification)
              }
            >
