...
/**
 * My Attendance content. Rendered as its own page (/attendance) and as a tab
 * in the profile page. When `embedded`, drops the PageContainer/PageHeader
 * chrome (the host provides them).
 */
export function AttendanceSection({ embedded = false }: { embedded?: boolean }) {
