...
describe('efficiency score', () => {
  it('counts acknowledgements and resolutions within 24 hours equally', () => {
    ...
    const result = pingSla([
      {
        createdAt,
        respondedAt: new Date('2026-08-02T10:00:00Z'),
        status: 'ACKNOWLEDGED',
      },
      {
        createdAt,
        respondedAt: new Date('2026-08-01T10:10:00Z'),
        status: 'RESOLVED',
      },
      {
        createdAt,
        respondedAt: new Date('2026-08-02T10:00:01Z'),
        status: 'RESOLVED',
      },
    ...
    const result = taskSla([
      {
        ...
        completedAt: new Date('2026-08-10T23:59:59Z'),
      },
      {
        dueDate: new Date('2026-08-10T00:00:00Z'),
